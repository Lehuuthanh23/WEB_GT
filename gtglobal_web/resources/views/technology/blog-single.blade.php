                        ...
                        <div class="col-lg-10">
                            <article class="blog-single__wrap">
                                <div class="blog-single__thumb">
                                    <img src="{{ $currentArticle->image_url[0] }}" alt=""
                                        style="border-radius: 20px;">
                                    <div class="blog-single__meta blog__meta"
                                        style="background-color: black; color: white;">
                                        <ul class="ul_li_center">
                                            <li><i class="far fa-clock"
                                                    style="color: white;"></i>{{ $currentArticle->published_at }}
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                <div class="blog-single__content mt-10">
                                    <h2 style="color: white;">{{ $currentArticle->title }}</h2>
                                    <div class="content">
                                        {!! $currentArticle->description !!}
                                    </div>
                                </div>
                                <script>
                                    document.querySelectorAll('.blog-single__content .content').forEach(div => {
                            ...
                            <div class="post-footer">
                                    ...
                                    <div class="social-share ul_li mt-10">
                                        <ul class="ul_li">
                                            ...
                                            <li><a href="#!"><i class="fab fa-instagram"
                                                        style="color: white;"></i></a></li>
                                            <li><a href="#!"><i class="fab fa-dribbble"
                                                        style="color: white;"></i></a></li>
                                        </ul>
                                    </div>
                                </div>
                                <div class="post-nav">
                                    <div class="post-nav__item post-left">
                                        <div class="post-nav__inner pos-rel" style="background-color: transparent;">
                                            <h3 class="border_effect"><a href="blog-single"
                                                    style="color: white;">{{ $articles->first()->title }}</a></h3>
                                            <span>{{ $articles->first()->published_at }}</span>
                                            <div class="icon">
                                                <i class="far fa-long-arrow-left"></i>
                                            </div>
                                            <a class="link" href="blog-single-{{ $articles->first()->id }}"></a>
                                        </div>
                                    </div>
                                    <div class="post-nav__item post-right">
                                        <div class="post-nav__inner pos-rel" style="background-color: transparent;">
                                            <h3 class="border_effect"><a href="blog-single"
                                                    style="color: white;">{{ $articles->last()->title }}</a></h3>
                                            <span>{{ $articles->last()->published_at }}</span>
                                            <div class="icon">
                                                <i class="far fa-long-arrow-right"></i>
                                            </div>
                                            <a class="link" href="blog-single-{{ $articles->last()->id }}"></a>
                                        </div>
                                    </div>
                                    <div class="grid_icon">
                                ...
                                <div class="post-related mt-80">
                                    ...
                                    <div class="row mt-none-30">
                                        @php
                                            $secondItem =
                                                $articles->count() > 1 ? $articles->get(1) : $articles->first(); // Lấy thứ 2 hoặc lặp lại đầu tiên
                                            $thirdItem =
                                                $articles->count() > 2 ? $articles->get(2) : $articles->first(); // Lấy thứ 3 hoặc lặp lại đầu tiên
                                            $itemsToShow =
                                                $articles->count() > 0
                                                    ? collect([$secondItem, $thirdItem])
                                                    : collect([]); // Đảm bảo có dữ liệu
                                        @endphp
                                                ...
                                                <div class="post-related__item">
                                                    <div class="thumb">
                                                        <a href="blog-single-{{ $item->id }}">
                                                            <img src="{{ $item->image_url ? $item->image_url[0] : asset('technology/img/blog/img_08.jpg') }}"
                                                                alt="" style="width: 500px; height: 300px;">
                                                        </a>
                                                    </div>
                                                    <h3 class="border_effect">
                                                        <a href="blog-single-{{ $item->id }}"
