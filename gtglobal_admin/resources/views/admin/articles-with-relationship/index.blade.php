...
@section('body')
    ...
    <articles-with-relationship-listing
        :data="{{ $data->toJson() }}"
        :url="'{{ url('admin/du-an-theo-danh-muc') }}'"
        inline-template>
            ...
            <div class="col">
                <div class="card">
                    <div class="card-header">
                        ...
                        <a class="btn btn-primary btn-spinner btn-sm pull-right m-b-0" href="{{ url('admin/du-an-theo-danh-muc/create') }}" role="button"><i class="fa fa-plus"></i>&nbsp; {{ trans('admin.articles-with-relationship.actions.create') }}</a>
                    </div>
                    <div class="card-body" v-cloak>
	                    ...
	                    <div class="no-items-found" v-if="!collection.length > 0">
                            ...
                            <a class="btn btn-primary btn-spinner" href="{{ url('admin/du-an-theo-danh-muc/create') }}" role="button"><i class="fa fa-plus"></i>&nbsp; {{ trans('admin.articles-with-relationship.actions.create') }}</a>
	                    </div>
                    </div>
                </div>
            </div>
        </div>
    </tin-tuc-with-relationship-listing>
