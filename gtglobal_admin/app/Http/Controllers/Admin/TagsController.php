...
class TagsController extends Controller
{
    ...
    public function store(StoreTag $request)
    {
        ...
        if ($request->ajax()) {
            return ['redirect' => url('admin/danh-muc-du-an'), 'message' => trans('brackets/admin-ui::admin.operation.succeeded')];
        }

        return redirect('admin/danh-muc-du-an');
    }
    ...
    public function update(UpdateTag $request, Tag $tag)
    {
        ...
        if ($request->ajax()) {
            return [
                'redirect' => url('admin/danh-muc-du-an'),
